...
class TestReadPedantic(unittest.TestCase):
    ...
    def test_e3t(self) -> None:
        ...
        with warnings.catch_warnings(record=True) as warnings_:
            _ = py2dm.Element3T.from_line(line, allow_float_matid=True)
            if warnings_:
    ...
    def test_ns(self) -> None:
        ...
        # Single line test
        line = 'NS 1 2 3 4 5 -6'
        string, flag = py2dm.NodeString.from_line(line)
        ...
        string, flag = py2dm.NodeString.from_line(line_1)
        self.assertFalse(flag)
        string, flag = py2dm.NodeString.from_line(line_2, string)
        self.assertFalse(flag)
        string, flag = py2dm.NodeString.from_line(line_3, string)
        self.assertTrue(flag)
